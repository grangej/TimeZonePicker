...
public protocol TimeZoneDataSourceDelegate {
...
public class TimeZoneDataSource {
    ...
    public var delegate: TimeZoneDataSourceDelegate?
    ...
    /// note: this search is done both in english and in the current system langauge (i.e. search text is searched against a localized city / country AND english city / country
    ///
